...
{
    { L"MS Mincho",       JF_LocalName0 },
    { L"MS PMincho",      JF_LocalName1 },
    { L"MS Gothic",       JF_LocalName2 },
    { L"MS PGothic",      JF_LocalName3 },
    { JF_LocalName0,      JF_LocalName0 },
    { JF_LocalName1,      JF_LocalName1 },
    { JF_LocalName2,      JF_LocalName2 },
    { JF_LocalName3,      JF_LocalName3 },
    { L"MS UI Gothic",    L"MS UI Gothic" },
    { L"MS UI Gothic 2",  L"MS UI Gothic" },
    { L"MS Shell Dlg",    L"MS UI Gothic" },
    { L"MS Shell Dlg 2",  L"MS UI Gothic" },
...
static const FONTSUBST JPN_MapForUninstallNoDroid[] =
{
    ...
    { L"MS PGothic",      NULL },
    { L"MS UI Gothic",    NULL },
    { L"MS UI Gothic 2",  NULL },
    { JF_LocalName0,      NULL },
    { JF_LocalName1,      NULL },
    { JF_LocalName2,      NULL },
    { JF_LocalName3,      NULL },
    { L"MS Shell Dlg",    NULL },
    { L"MS Shell Dlg 2",  NULL },
    { L"System",          NULL },
    { L"Tahoma",          NULL },
};
...
BOOL DoMakeUserJapanese(HWND hwnd)
{
    ...
    MRegKey keyConsole;
    if (keyConsole.RegOpenKeyEx(HKEY_CURRENT_USER, TEXT("Console"),
                                0, KEY_WRITE | KEY_ENUMERATE_SUB_KEYS) == NOERROR)
    {
